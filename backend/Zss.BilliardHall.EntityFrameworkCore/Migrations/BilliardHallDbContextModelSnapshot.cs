...
{
    [DbContext(typeof(BilliardHallDbContext))]
    partial class BilliardHallDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Zss.BilliardHall.Entities.BilliardTable", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppBilliardTables", (string)null);
                });

            modelBuilder.Entity("Zss.BilliardHall.Entities.PaymentOrder", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppPaymentOrders", (string)null);
                });

            modelBuilder.Entity("Zss.BilliardHall.Entities.Store", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Zss.BilliardHall.Entities.TableSession", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppTableSessions", (string)null);
                });
            ...
            modelBuilder.Entity("Zss.BilliardHall.Entities.BilliardTable", b =>
                {
                    b.HasOne("Zss.BilliardHall.Entities.Store", "Store")
                        .WithMany()
            ...
            modelBuilder.Entity("Zss.BilliardHall.Entities.PaymentOrder", b =>
                {
                    b.HasOne("Zss.BilliardHall.Entities.TableSession", "Session")
                        .WithMany()
            ...
            modelBuilder.Entity("Zss.BilliardHall.Entities.TableSession", b =>
                {
                    b.HasOne("Zss.BilliardHall.Entities.BilliardTable", "Table")
                        .WithMany()
