...
namespace Zss.BilliardHall.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AppBilliardTables_AppStores_StoreId",
                        column: x => x.StoreId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HourlyRateSnapshot = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppTableSessions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppTableSessions_AppBilliardTables_TableId",
                        column: x => x.TableId,
                        principalTable: "AppBilliardTables",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<int>(type: "integer", nullable: false),
                    ThirdPartyTransactionId = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    PaymentTime = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    ExpirationTime = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    CallbackData = table.Column<string>(type: "character varying(2000)", maxLength: 2000, nullable: false),
                    Remarks = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: false),
                    ExtraProperties = table.Column<string>(type: "text", nullable: false),
                    ConcurrencyStamp = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: false),
                    CreationTime = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppPaymentOrders", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppPaymentOrders_AppTableSessions_SessionId",
                        column: x => x.SessionId,
                        principalTable: "AppTableSessions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppBilliardTables_QrCode",
                table: "AppBilliardTables",
                column: "QrCode");

            migrationBuilder.CreateIndex(
                name: "IX_AppBilliardTables_StoreId",
                table: "AppBilliardTables",
                column: "StoreId");

            migrationBuilder.CreateIndex(
                name: "IX_AppBilliardTables_StoreId_Number",
                table: "AppBilliardTables",
                columns: new[] { "StoreId", "Number" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_AppPaymentOrders_OrderNumber",
                table: "AppPaymentOrders",
                column: "OrderNumber",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_AppPaymentOrders_PaymentTime",
                table: "AppPaymentOrders",
                column: "PaymentTime");

            migrationBuilder.CreateIndex(
                name: "IX_AppPaymentOrders_SessionId",
                table: "AppPaymentOrders",
                column: "SessionId");

            migrationBuilder.CreateIndex(
                name: "IX_AppPaymentOrders_Status",
                table: "AppPaymentOrders",
                column: "Status");

            migrationBuilder.CreateIndex(
                name: "IX_AppPaymentOrders_UserId",
                table: "AppPaymentOrders",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_AppStores_Name",
                table: "AppStores",
                column: "Name");

            migrationBuilder.CreateIndex(
                name: "IX_AppTableSessions_SessionToken",
                table: "AppTableSessions",
                column: "SessionToken",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_AppTableSessions_StartTime",
                table: "AppTableSessions",
                column: "StartTime");

            migrationBuilder.CreateIndex(
                name: "IX_AppTableSessions_TableId",
                table: "AppTableSessions",
                column: "TableId");

            migrationBuilder.CreateIndex(
                name: "IX_AppTableSessions_UserId",
                table: "AppTableSessions",
                column: "UserId");
