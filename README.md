...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p f32d193c-efa5-42c2-83dd-c06531c2d166
```

> `f32d193c-efa5-42c2-83dd-c06531c2d166` is the password of the certificate, you can change it to any password you want.
