...
### 1. 核心架构文档
- **Wolverine模块化架构蓝图.md** (`doc/03_系统架构设计/`) - **v1.3.0 归并强化**
  - 序章：垂直切片架构理念（整合自《垂直切片架构说明》）
  - 完整架构设计与最佳实践
  - 附录A：Wolverine框架核心特性详解（整合自《Wolverine框架介绍》）
  - 附录B：Wolverine与MediatR深度对比
  - 附录C：测试支持与最佳实践
  - 附录D：从ABP分层架构迁移指南
  - 附录E：命名约定与代码组织
  
- ~~**垂直切片架构说明.md**~~ → 已归并到架构蓝图序章
  
- ~~**Wolverine框架介绍.md**~~ → 已归并到架构蓝图附录A-E
...
│   ├── 技术选型.md ✏️ (已更新)
│   ├── 设计原则.md ✏️ (已更新)
│   ├── Wolverine模块化架构蓝图.md ✅ (v1.3.0 归并强化)
│   ├── ~垂直切片架构说明.md~ → 已归并
│   └── Marten数据访问.md ✨ (新增)
├── 04_模块设计/
│   └── README.md ✏️ (已更新)
...
详细的迁移指南请参阅：
- [Wolverine模块化架构蓝图（序章）](doc/03_系统架构设计/Wolverine模块化架构蓝图.md) - 第 6 节
