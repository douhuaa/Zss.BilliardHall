...
**测试类**：`ADR_0340_Architecture_Tests.cs`  
**版本**：1.0  
**最后更新**：2026-01-24
...
**相关测试**：
- `ADR_0340_Architecture_Tests.Platform_Should_Reference_Serilog()`
- `ADR_0340_Architecture_Tests.PlatformBootstrapper_Should_Configure_Serilog()`
...
**相关测试**：
- `ADR_0340_Architecture_Tests.Platform_Should_Reference_OpenTelemetry()`
- `ADR_0340_Architecture_Tests.PlatformBootstrapper_Should_Configure_OpenTelemetry()`
...
**相关测试**：
- `ADR_0340_Architecture_Tests.Modules_Cannot_Reference_Serilog_Directly()`（将在 L2 Roslyn Analyzer 中实现）
...
**架构原因**：
- Platform 层负责技术基础设施配置（ADR-0002）
- Application/Modules 层只使用抽象接口
- 保持业务层对日志实现的无感知

**相关测试**：
- `ADR_0340_Architecture_Tests.Modules_Cannot_Reference_Serilog_Directly()`
- `ADR_0340_Architecture_Tests.Application_Cannot_Configure_Serilog()`
- `ADR_0340_Architecture_Tests.Modules_Cannot_Reference_OpenTelemetry_Directly()`
- `ADR_0340_Architecture_Tests.Application_Cannot_Configure_OpenTelemetry()`
...
**违反的规则**：ADR-340.5  
**相关测试**：`ADR_0340_Architecture_Tests.Modules_Cannot_Reference_Serilog_Directly()`
...
**违反的规则**：ADR-340.2  
**相关测试**：`ADR_0340_Architecture_Tests.PlatformBootstrapper_Should_Configure_OpenTelemetry()`
