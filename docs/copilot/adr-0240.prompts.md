# ADR-240：Handler 异常处理与重试标准 - Copilot 提示词库

**关联 ADR**：[ADR-240](../adr/runtime/ADR-240-handler-exception-handling-retry-standards.md)  
**测试类**：`ADR_0240_Architecture_Tests.cs`  
**版本**：1.0  
**最后更新**：2026-01-24
...
public class OrderRepository
{
    ...
    {
        // SQL Server 暂时性错误代码
        return ex.Number is -2 or 1205 or 49918 or 49919 or 49920 or 4060 or 4221 or 40197 or 40501 or 40613;
    }
}
