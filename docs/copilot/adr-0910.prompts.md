# ADR-0910 Copilot Prompts：README 编写与维护

> ⚠️ **权威声明**  
> 本文档不具备裁决权，仅提供场景化指导。  
> 所有架构决策以 [ADR-0910 正文](../adr/governance/ADR-0910-readme-governance-constitution.md) 为准。
...
- **ADR 正文（权威）**：[ADR-0910](../adr/governance/ADR-0910-readme-governance-constitution.md)
...
| 版本  | 日期         | 变更说明         |
|-----|------------|--------------|
| 1.0 | 2026-01-25 | 初版，配合 ADR-0910 创建 |
