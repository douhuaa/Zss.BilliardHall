# ADR-0301 Copilot 提示词

**版本**：1.0  
**创建日期**：2026-01-24  
**ADR**: docs/adr/*/ADR-0301-*.md
...
### ❌ 反模式 1：违反核心约束
参考 ADR-0301 正文中的"规则本体"章节

### ❌ 反模式 2：忽略架构测试失败
当 ADR_0301_Architecture_Tests 失败时，必须：
1. 查看测试失败消息
2. 定位违规代码
3. 按 ADR 要求修复
4. 或申请破例并记录
...
### 测试失败：ADR_0301_Architecture_Tests
...
详见 ADR-0301 正文的"规则本体"和"执法模型"章节。

---

## 相关资源

- ADR 正文: docs/adr/*/ADR-0301-*.md
