...
根据 [ADR-001](../adr/constitutional/ADR-001-modular-monolith-vertical-slice-architecture.md)，
模块必须隔离。以下是实现步骤：
...
如何验证：运行架构测试 `ADR_001_Architecture_Tests`

详细判定规则请参考 [ADR-001](链接)。
```
...
根据 [ADR-005](链接)，模块使用 CQRS 模式。以下是实现步骤：
