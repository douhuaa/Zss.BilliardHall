...
- [ADR-001 v3.2 对齐](adr-001-v3.2-alignment.md)
- [ADR-006 编号审计](adr-006-numbering-audit.md)
- [ADR-006 合并前检查清单](adr-006-pre-merge-checklist.md)
- [ADR 提案体系实施](adr-proposals-implementation-summary.md)
- [ADR 治理自动化实施](adr-automation-implementation.md)
- [P0 ADR 实施总结](p0-adr-implementation-summary.md)

### 测试
- [ADR-测试一致性实施](adr-test-consistency-implementation.md)
- [架构测试改进](architecture-tests-improvement-summary.md)
- [架构测试结果报告](ARCHITECTURE-TEST-RESULTS.md)
...
- [脚本 JSON 对齐继续](script-json-alignment-continuation.md)
