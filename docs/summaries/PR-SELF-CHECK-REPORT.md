...
**修正**：
- 明确位置：`docs/adr/governance/ADR-0000-architecture-tests.md` 第 110-132 行
- 规则编号：ADR-0000.X
...
**ADR-0000（元治理升级）**：
- ✅ ADR-0000.X: 规则冲突优先级裁决（v2.0 新增）
- ✅ ADR-0000.Y: 破例成本管理（v2.0 新增）
...
- 考虑将 ADR-0000 反作弊检查排除占位符测试（L2/L3 规则）
