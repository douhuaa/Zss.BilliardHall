...
| ADR关系与溯源管理**宪法** | ADR关系与溯源管理**治理规范** | 宪法→治理规范 | ADR-940 |
| 指南与FAQ文档治理**宪法** | 指南与FAQ文档**治理规范** | 宪法→治理规范 | ADR-950 |
| Onboarding文档治理**宪法** | Onboarding文档**治理规范** | 宪法→治理规范 | ADR-960 |
| ADR生命周期一体化同步机制**宪法** | ADR生命周期一体化同步机制**治理规范** | 宪法→治理规范 | ADR-980 |
...
5. **ADR-940**（v1.0 → v1.1）
   - 标题：ADR关系与溯源管理宪法 → **ADR关系与溯源管理治理规范**
   - 元数据：更新 title、version、date
   - 说明：ADR关系管理治理规范

6. **ADR-950**（v1.0 → v1.1）
   - 标题：指南与FAQ文档治理宪法 → **指南与FAQ文档治理规范**
   - 元数据：更新 title、version、date
   - 说明：指南和FAQ文档治理规范

7. **ADR-960**（v1.0 → v1.1）
   - 标题：Onboarding文档治理宪法 → **Onboarding文档治理规范**
   - 元数据：更新 title、version、date
   - 说明：新人入职文档治理规范

8. **ADR-980**（v1.0 → v1.1）
   - 标题：ADR生命周期一体化同步机制宪法 → **ADR生命周期一体化同步机制治理规范**
   - 元数据：更新 title、version、date
   - 说明：ADR变更同步治理规范
