...
| ID | ADR | 规则 | 违规位置 | 原因 | 到期版本 | 负责人 | 偿还计划 | 审批人 | 状态 |
|-----|-----|------|---------|------|---------|--------|---------|--------|------|
| 示例 | ADR-0005.3 | 模块间异步 | Members→Orders | 遗留迁移 | v2.1.0 | @dev1 | Q1 事件化 | @arch | 🚧 |

### 示例详细记录（教学用途）

**ID**: ARCH-001  
**违反 ADR**: ADR-0005.3（模块间默认异步通信）  
**规则编号**: ADR-0005.3
...
|-----|-----|------|---------|---------|----------|--------|
| ARCH-000 | ADR-0001 | Members 引用 Orders | 2025-12-01 | 2025-12-15 | 契约移至 Platform | @dev2 |
...
| 版本 | 日期 | 变更说明 | 修订人 |
|-----|------|---------|--------|
| 2.0 | 2026-01-25 | 增加到期版本号、CI 监控、延期限制（ADR-0000.Y） | GitHub Copilot |
