...
| 段落               | 职责                     | 裁决力 | 长度限制  |
| ---------------- | ---------------------- | --- | ----- |
| 1. 规则本体         | 定义不可协商的架构规则            | ✅   | ≤ 1 页  |
| 2. 执法模型         | 定义如何执行规则（测试、工具、流程）     | ✅   | 无限制   |
| 3. 破例与归还        | 定义破例条件和归还机制            | ✅   | 无限制   |
| 4. 变更政策         | 定义 ADR 修改和废弃流程         | ✅   | 无限制   |
| 5. 明确不管什么      | 定义 ADR 不负责的范围          | ✅   | 无限制   |
| 6. 非裁决性参考      | 提供理解性材料（术语、示例、历史）      | ❌   | 无限制   |
