...
| 层级 | 编号范围 | 文档数量 | 占比 |
|-----|---------|---------|------|
| 宪法层 (constitutional) | 0001-0099 | 9 | 20.5% |
| 结构层 (structure) | 0100-0199 | 5 | 11.4% |
| 运行层 (runtime) | 0200-0299 | 4 | 9.1% |
| 技术层 (technical) | 0300-0399 | 4 | 9.1% |
| 治理层 (governance) | 0900-0999 | 22 | 50.0% |
| **总计** | | **44** | **100%** |
