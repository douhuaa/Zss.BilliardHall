...
| **结构层** | `ADR-100~199`       | `structure/`      | 模块静态边界/组织细化   | ✅ 已有 3 个 ADR |
...
- [**ADR-0110：测试目录组织规范**](structure/ADR-0110-test-directory-organization.md) - 架构测试集中管理、单元测试镜像规则
- [**ADR-0120：功能切片命名规范**](structure/ADR-0120-feature-naming-conventions.md) - Command/Query/Handler/Endpoint 命名约定
- [**ADR-0121：契约命名规范**](structure/ADR-0121-contract-naming-conventions.md) - 跨模块契约和查询接口命名规范
