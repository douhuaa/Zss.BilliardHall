...
| **宪法层 ADR** | ADR-0000 至 ADR-0005，构成架构的基础约束 |
| **流程 ADR** | ADR-0000A，定义 ADR 管理流程 |
| **普通 ADR** | ADR-0006+，后续的架构决策 |
...
**每个 ADR 必须有对应的 Copilot Prompt 文件**。
...
| 版本 | 日期 | 变更说明 | 修订人 |
|------|------|---------|--------|
| 1.0 | 2026-01-21 | 初始版本，定义 ADR 新增和修订流程 | @douhuaa |
