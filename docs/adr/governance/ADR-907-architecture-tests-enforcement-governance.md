...
| **ADR-907.4_5** | L1  | Analyzer 检测能力完整性验证 | §ADR-907.4_5 |
| **ADR-907.4_6** | L1  | ADR 生命周期同步校验 | §ADR-907.4_6 |
