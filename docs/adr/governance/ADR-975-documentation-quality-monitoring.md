...
### ADR-975.1：质量指标定义（Rule）

#### ADR-975.1.1 文档质量必须通过以下指标量化评估
文档质量 **必须**通过以下指标量化评估。
...
### ADR-975.2：自动化检测机制（Rule）

#### ADR-975.2.1 质量检测必须自动化执行
质量检测 **必须**自动化执行。
...
### ADR-975.3：定期报告生成（Rule）

#### ADR-975.3.1 必须每月生成文档质量报告
**必须**每月生成文档质量报告。
...
|---------|--------|---------|--------------|
| **ADR-975.1.1** | L1 | 文档扫描质量指标定义 | §ADR-975.1.1 |
| **ADR-975.1.2** | L1 | 文档扫描核心指标 | §ADR-975.1.2 |
| **ADR-975.1.3** | L1 | 文档扫描计算公式 | §ADR-975.1.3 |
| **ADR-975.1.4** | L1 | 文档扫描质量等级 | §ADR-975.1.4 |
| **ADR-975.1.5** | L1 | 文档扫描核心原则 | §ADR-975.1.5 |
| **ADR-975.2.1** | L1 | 文档扫描自动化检测 | §ADR-975.2.1 |
| **ADR-975.2.2** | L1 | 文档扫描链接有效性检测 | §ADR-975.2.2 |
| **ADR-975.2.3** | L1 | 文档扫描代码示例可编译性检测 | §ADR-975.2.3 |
| **ADR-975.2.4** | L1 | 文档扫描文档完整性检测 | §ADR-975.2.4 |
| **ADR-975.2.5** | L1 | 文档扫描时效性检测 | §ADR-975.2.5 |
| **ADR-975.2.6** | L1 | 文档扫描核心原则 | §ADR-975.2.6 |
| **ADR-975.3.1** | L1 | 文档扫描定期报告生成 | §ADR-975.3.1 |
| **ADR-975.3.2** | L1 | 文档扫描报告位置 | §ADR-975.3.2 |
| **ADR-975.3.3** | L1 | 文档扫描报告结构 | §ADR-975.3.3 |
| **ADR-975.4.1** | L1 | 文档扫描最低质量阈值 | §ADR-975.4.1 |
| **ADR-975.4.2** | L1 | 文档扫描硬失败项 | §ADR-975.4.2 |
| **ADR-975.4.3** | L2 | 文档扫描软失败项 | §ADR-975.4.3 |
