...
|---------|--------|---------|--------------|
| **ADR-930.1.1** | L2 | PR 模板验证 + 人工审查 | §ADR-930.1.1 |
| **ADR-930.1.2** | L2 | CI 提醒 + 人工审查 | §ADR-930.1.2 |
| **ADR-930.1.3** | L1 | ArchitectureTests 自动阻断 + CI Gate | §ADR-930.1.3 |
| **ADR-930.1.4** | L2 | GitHub Branch Protection + 人工审查 | §ADR-930.1.4 |
| **ADR-930.1.5** | L2 | 人工审查 + PR 标签检查 | §ADR-930.1.5 |
