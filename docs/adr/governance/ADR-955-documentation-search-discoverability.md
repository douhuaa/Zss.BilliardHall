...
|---------|--------|---------|--------------|
| **ADR-955.1.1** | L1 | 自动检查文档元数据 | §ADR-955.1.1 |
| **ADR-955.1.2** | L1 | 自动检查文档目录结构 | §ADR-955.1.2 |
| **ADR-955.1.3** | L2 | 人工审查重复内容 | §ADR-955.1.3 |
| **ADR-955.2.1** | L1 | 自动检查文档标题关键词 | §ADR-955.2.1 |
| **ADR-955.2.2** | L1 | 自动检查文档摘要 | §ADR-955.2.2 |
| **ADR-955.2.3** | L1 | 自动检查搜索引擎功能 | §ADR-955.2.3 |
| **ADR-955.2.4** | L2 | 定期日志分析脚本 | §ADR-955.2.4 |
| **ADR-955.3.1** | L1 | 定期审计脚本 | §ADR-955.3.1 |
| **ADR-955.3.2** | L2 | 人工创建 Issue | §ADR-955.3.2 |
| **ADR-955.3.3** | L1 | 自动存档审计报告 | §ADR-955.3.3 |
