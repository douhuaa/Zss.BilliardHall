...
### ADR-945.1：ADR 演进时间线生成机制（Rule）

#### ADR-945.1.1 自动生成 ADR 演进时间线
...
### ADR-945.2：变更频率统计与分析（Rule）

#### ADR-945.2.1 变更频率统计和分析
...
### ADR-945.3：高频 ADR 警示与治理（Rule）

#### ADR-945.3.1 高频 ADR 警示与治理
...
### ADR-945.4：演进视图可视化标准（Rule）

#### ADR-945.4.1 演进视图可视化标准
...
|-----------------|-----|------|--------------|
| **ADR-945.1.1** | L1  |      | §ADR-945.1.1 |
| **ADR-945.2.1** | L1  |      | §ADR-945.2.1 |
| **ADR-945.3.1** | L2  |      | §ADR-945.3.1 |
| **ADR-945.4.1** | L2  |      | §ADR-945.4.1 |
