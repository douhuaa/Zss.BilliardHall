...
### ADR-007-A_1：Guardian 决策失败模型（Rule）

#### ADR-007-A_1_1 失败类型定义
...
### ADR-007-A_2：Guardian 决策可审计性（Rule）

#### ADR-007-A_2_1 决策证据要求
...
### ADR-007-A_3：纠偏触发机制（Rule）

#### ADR-007-A_3_1 自动纠偏（L1）
...
### ADR-007-A_5：Guardian 非判例原则（Rule）
...
|--------------|-------|----------|
| ADR-007-A_1_1 | L1 | 决策结果一致性校验 |
| ADR-007-A_2_1 | L1 | Guardian 输出结构扫描 |
| ADR-007-A_3_1 | L1 | CI 自动失效处理 |
| ADR-007-A_3_2 | L2 | 人工 Review |
| ADR-007-A_4_1 | L2 | 治理产物检查 |
| ADR-007-A_5_1 | L1 | 判例引用检测 |
