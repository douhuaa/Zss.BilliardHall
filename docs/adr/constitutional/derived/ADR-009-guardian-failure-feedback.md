...
### ADR-009.1：Guardian 决策失败模型（Rule）
...
### ADR-009.2：Guardian 决策可审计性（Rule）
...
|--------------|-------|----------|
| ADR-009.1.1 | L1 | 决策结果一致性校验 |
| ADR-009.2.1 | L1 | Guardian 输出结构扫描 |
| ADR-009.3.1 | L1 | CI 自动失效处理 |
| ADR-009.3.2 | L2 | 人工 Review |
| ADR-009.4.1 | L2 | 治理产物检查 |
| ADR-009.5.1 | L1 | 判例引用检测 |
