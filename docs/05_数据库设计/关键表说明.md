---
title: "关键表说明"
description: "核心业务表详细设计说明和业务逻辑分析"
section: "5.3"
version: "1.0.0"
author: "业务分析师"
maintainer: "开发工程师"
...
category: "数据库设计"
level: "必读"
audience: ["开发工程师", "测试工程师", "业务分析师"]
keywords: ["关键表", "业务逻辑", "数据模型", "实体关系", "业务规则", "数据一致性"]
tags: ["business-logic", "data-model", "core-tables", "entity-relationships"]
status: "完成"
dependencies: ["05_数据库设计/表结构定义.md"]
related_docs: ["05_数据库设计/数据迁移方案.md", "05_数据库设计/索引与优化.md"]
reading_time: "35分钟"
difficulty: "中级"
---
...
**导航路径**: [🏠 项目首页](../../README.md) > [📊 数据库设计](README.md) > 💡 关键表说明
...
stateDiagram-v2
    ...
    Reserved --> Occupied : 预约开台
    Reserved --> Available : 取消预约
    Occupied --> Available : 结束会话
    Available --> Maintenance : 维护
    Maintenance --> Available : 维护完成
    Available --> OutOfOrder : 故障
    OutOfOrder --> Available : 修复完成
```
