...
2. **创建了破例记录表** (`docs/ARCH-VIOLATIONS.md`)
   - 活跃破例（尚未归还）
   - 已归还破例（历史审计）
   - 永久破例（需全体批准）
   - 被拒绝申请（决策参考）
...
2. `docs/ARCH-VIOLATIONS.md` - 破例记录表（215 行）
...
2. **批准破例**
   - 根据影响时长选择审批级别
   - 在 `ARCH-VIOLATIONS.md` 中记录破例
   - 设置提醒，跟踪归还进度

3. **定期审计**
   - 每季度检查 `ARCH-VIOLATIONS.md`
   - 核实已归还的破例是否真正修复
   - 评估破例趋势，决定是否需要修订 ADR
