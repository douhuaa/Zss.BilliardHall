---
title: "设备管理模块"
description: "自助台球系统设备管理模块详细设计说明"
version: "2.0.0"
author: "硬件架构师"
maintainer: "硬件开发团队"
created: "2024-01-01"
...
category: "模块设计"
level: "核心"
audience: ["硬件开发工程师", "物联网工程师"]
keywords: ["设备管理", "物联网", "MQTT", "设备控制", "Wolverine", "垂直切片"]
tags: ["device", "iot", "mqtt", "hardware", "vertical-slice"]
dependencies: ["台球桌计费", "系统架构"]
estimated_reading_time: "14分钟"
architecture_status: "架构实现已更新至 Wolverine"
---
...
<!-- Keywords for Search -->
**关键词**: `设备管理` `物联网` `MQTT` `设备控制` `Wolverine` `垂直切片`

---

> ## ⚠️ 架构实现说明
> 
> 本文档描述设备管理模块的**业务需求和功能说明**。
> 
...
>    - 查看 Devices 模块的完整垂直切片实现方式
> 
> 2. **[系统模块划分 - Devices 模块](../03_系统架构设计/系统模块划分.md#8-devices-模块硬件集成)** ⭐⭐
>    - Devices 模块的功能切片、领域模型、事件定义
> 
> 3. **[Wolverine快速上手指南](../03_系统架构设计/Wolverine快速上手指南.md)** ⭐⭐⭐
>    - 如何实现设备控制功能（ControlDoorLock、ControlLighting 等）
> 
> ### 📁 新架构目录结构：
> 
> ```
...
> ├── ControlDoorLock/
> │   ├── ControlDoorLock.cs
> │   ├── ControlDoorLockHandler.cs
> │   └── ControlDoorLockEndpoint.cs
> ├── ControlLighting/
> │   ├── ControlLighting.cs
> │   └── ControlLightingHandler.cs
> ├── GetDeviceStatus/
> ├── RegisterDevice/
> ├── Handlers/                     # 事件监听器
> │   ├── SessionStartedHandler.cs  # 监听 SessionStarted → 开灯/开门
> │   └── SessionEndedHandler.cs    # 监听 SessionEnded → 关灯
> ├── Events/
> │   ├── DeviceStatusChanged.cs
> │   ├── DoorLockControlled.cs
> │   └── LightingControlled.cs
> └── Device.cs                     # 聚合根
> ```
> 
> ### 🔄 架构变更要点：
...
> |----------------|-------------------|------|
> | 设备控制服务 (DeviceAppService) | ControlDoorLockHandler | 按功能切片 |
> | MQTT 客户端管理 | IDeviceGateway（注入 Handler） | 依赖注入简化 |
> | 事件订阅 | Wolverine Event Handlers | 框架级支持 |
