...
migration_status: "架构迁移中 - 个别模块文档待更新"
---
...
|------|----------|----------|----------|---------|
| 🏃 [会员管理模块](会员管理模块.md) | 会员体系、积分管理 | 等级算法、权限控制 | 业务开发必读 | ✅ v2.0.0 |
| 💰 [台球桌计费模块](台球桌计费模块.md) | 计费规则、套餐管理 | 计时算法、价格策略 | 核心业务模块 | ✅ v2.0.0 |
| 💳 [支付模块](支付模块.md) | 支付流程、退款管理 | 幂等性、事务处理 | 支付集成必读 | ✅ v2.0.0 |
| 🖥️ [设备管理模块](设备管理模块.md) | 设备控制、状态监控 | 物联网协议、实时通信 | 硬件对接必读 | ✅ v2.0.0 |
| 📊 [报表与统计模块](报表与统计模块.md) | 数据分析、报表生成 | 数据聚合、可视化 | 数据分析参考 | ✅ v2.0.0 |

> 💡 **提示**: 以上模块文档已添加 Wolverine 架构迁移说明。文档中保留业务需求和功能说明，架构实现请参考 [Wolverine模块化架构蓝图](../03_系统架构设计/Wolverine模块化架构蓝图.md)
...
*最后更新: 2024-01-15 | 版本: v1.2.0 | 架构迁移状态: ✅ 所有模块文档已添加 Wolverine 架构说明*