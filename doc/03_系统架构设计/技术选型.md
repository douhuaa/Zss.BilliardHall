...
**适用场景**: 如果对复杂查询、并发写入有更高要求可考虑PostgreSQL
...
| 层次 | 技术选择 | 版本 | 选择理由 |
|------|----------|------|----------|
| **前端框架** | Vue 3 + TypeScript | 3.3+ | 易学易用、生态成熟 |
| **UI组件库** | Element Plus | 2.4+ | 企业级、组件丰富 |
| **构建工具** | Vite | 4.0+ | 开发体验佳、构建快速 |
| **后端框架** | ASP.NET Core | 8.0 | 高性能、跨平台 |
| **应用框架** | ABP Framework | 7.0+ | 快速开发、DDD支持 |
| **ORM框架** | Entity Framework Core | 8.0 | Code First、类型安全 |
| **数据库** | MySQL | 8.0 | 性能优秀、成本低 |
