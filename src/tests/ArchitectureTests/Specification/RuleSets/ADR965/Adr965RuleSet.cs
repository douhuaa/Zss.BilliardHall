namespace Zss.BilliardHall.Tests.ArchitectureTests.Specification.RuleSets.ADR965;

/// <summary>
/// ADR-965：注释与文档规范
/// 定义治理层相关规则和约束（此为框架性定义，需根据实际测试文件完善）
/// </summary>
public sealed class Adr965RuleSet : IArchitectureRuleSetDefinition
{
    /// <summary>
    /// ADR 编号
    /// </summary>
    public int AdrNumber => 965;
    ...
    {
        var ruleSet = new ArchitectureRuleSet(965);
