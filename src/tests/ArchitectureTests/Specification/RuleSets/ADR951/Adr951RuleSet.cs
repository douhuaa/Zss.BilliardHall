namespace Zss.BilliardHall.Tests.ArchitectureTests.Specification.RuleSets.ADR951;

/// <summary>
/// ADR-951：技术债务管理
/// 定义治理层相关规则和约束（此为框架性定义，需根据实际测试文件完善）
/// </summary>
public sealed class Adr951RuleSet : IArchitectureRuleSetDefinition
{
    /// <summary>
    /// ADR 编号
    /// </summary>
    public int AdrNumber => 951;
    ...
    {
        var ruleSet = new ArchitectureRuleSet(951);
