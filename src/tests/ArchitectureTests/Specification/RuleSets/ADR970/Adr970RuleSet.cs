namespace Zss.BilliardHall.Tests.ArchitectureTests.Specification.RuleSets.ADR970;

/// <summary>
/// ADR-970：可观测性与监控
/// 定义治理层相关规则和约束（此为框架性定义，需根据实际测试文件完善）
/// </summary>
public sealed class Adr970RuleSet : IArchitectureRuleSetDefinition
{
    /// <summary>
    /// ADR 编号
    /// </summary>
    public int AdrNumber => 970;
    ...
    {
        var ruleSet = new ArchitectureRuleSet(970);
