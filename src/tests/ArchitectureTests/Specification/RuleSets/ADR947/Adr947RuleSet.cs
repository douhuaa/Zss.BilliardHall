namespace Zss.BilliardHall.Tests.ArchitectureTests.Specification.RuleSets.ADR947;

/// <summary>
/// ADR-947：日志与审计规范
/// 定义治理层相关规则和约束（此为框架性定义，需根据实际测试文件完善）
/// </summary>
public sealed class Adr947RuleSet : IArchitectureRuleSetDefinition
{
    /// <summary>
    /// ADR 编号
    /// </summary>
    public int AdrNumber => 947;
    ...
    {
        var ruleSet = new ArchitectureRuleSet(947);
