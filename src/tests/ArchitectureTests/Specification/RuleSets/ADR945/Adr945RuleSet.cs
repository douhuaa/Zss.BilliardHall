namespace Zss.BilliardHall.Tests.ArchitectureTests.Specification.RuleSets.ADR945;

/// <summary>
/// ADR-945：性能监控与指标规范
/// 定义治理层相关规则和约束（此为框架性定义，需根据实际测试文件完善）
/// </summary>
public sealed class Adr945RuleSet : IArchitectureRuleSetDefinition
{
    /// <summary>
    /// ADR 编号
    /// </summary>
    public int AdrNumber => 945;
    ...
    {
        var ruleSet = new ArchitectureRuleSet(945);

        // Rule 1: 核心规则（需根据测试文件完善）
        ruleSet.AddRule(
            ruleNumber: 1,
            summary: "性能监控与指标规范核心规则",
