namespace Zss.BilliardHall.Tests.ArchitectureTests.Specification.RuleSets.ADR980;

/// <summary>
/// ADR-980：部署策略与流程
/// 定义治理层相关规则和约束（此为框架性定义，需根据实际测试文件完善）
/// </summary>
public sealed class Adr980RuleSet : IArchitectureRuleSetDefinition
{
    /// <summary>
    /// ADR 编号
    /// </summary>
    public int AdrNumber => 980;
    ...
    {
        var ruleSet = new ArchitectureRuleSet(980);
