namespace Zss.BilliardHall.Tests.ArchitectureTests.Specification.RuleSets.ADR952;

/// <summary>
/// ADR-952：重构策略与实践
/// 定义治理层相关规则和约束（此为框架性定义，需根据实际测试文件完善）
/// </summary>
public sealed class Adr952RuleSet : IArchitectureRuleSetDefinition
{
    /// <summary>
    /// ADR 编号
    /// </summary>
    public int AdrNumber => 952;
    ...
    {
        var ruleSet = new ArchitectureRuleSet(952);
