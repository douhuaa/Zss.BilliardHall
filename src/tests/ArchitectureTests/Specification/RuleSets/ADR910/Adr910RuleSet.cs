namespace Zss.BilliardHall.Tests.ArchitectureTests.Specification.RuleSets.ADR910;

/// <summary>
/// ADR-910：文档维护与链接完整性
/// 定义治理层相关规则和约束（此为框架性定义，需根据实际测试文件完善）
/// </summary>
public sealed class Adr910RuleSet : IArchitectureRuleSetDefinition
{
    /// <summary>
    /// ADR 编号
    /// </summary>
    public int AdrNumber => 910;
