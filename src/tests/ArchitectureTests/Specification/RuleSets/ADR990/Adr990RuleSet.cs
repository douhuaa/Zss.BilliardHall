namespace Zss.BilliardHall.Tests.ArchitectureTests.Specification.RuleSets.ADR990;

/// <summary>
/// ADR-990：运维规范与最佳实践
/// 定义治理层相关规则和约束（此为框架性定义，需根据实际测试文件完善）
/// </summary>
public sealed class Adr990RuleSet : IArchitectureRuleSetDefinition
{
    /// <summary>
    /// ADR 编号
    /// </summary>
    public int AdrNumber => 990;
    ...
    {
        var ruleSet = new ArchitectureRuleSet(990);

        // Rule 1: 核心规则（需根据测试文件完善）
        ruleSet.AddRule(
            ruleNumber: 1,
            summary: "运维规范与最佳实践核心规则",
