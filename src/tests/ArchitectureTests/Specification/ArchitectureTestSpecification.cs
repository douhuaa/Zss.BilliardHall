...
/// </summary>
public static class ArchitectureTestSpecification
{
    /// <summary>
    /// 命名空间规范
    /// </summary>
    public static _Namespaces Namespaces { get; } = _Namespaces.Instance;

    /// <summary>
    /// ADR 规范（包含 Patterns、Paths、KnownDocuments）
    /// </summary>
    public static _Adr Adr { get; } = _Adr.Instance;

    /// <summary>
    /// 语义规范（包含裁决关键词、关键标题等）
    /// </summary>
    public static _Semantics Semantics { get; } = _Semantics.Instance;

    /// <summary>
    /// 输出规范（包含三态输出标准）
    /// </summary>
    public static _Output Output { get; } = _Output.Instance;

    /// <summary>
    /// Onboarding 内容规范
    /// </summary>
    public static _Onboarding Onboarding { get; } = _Onboarding.Instance;
}
