...
public sealed class AdrDecisionGenerator : IAdrDecisionGenerator
{
    ...
    private static void AppendRuleHeader(
        StringBuilder sb,
        string ruleIdText,
        string summary,
        DecisionGenerationOptions options)
    ...
    private static void AppendClauseSection(StringBuilder sb, ArchitectureClauseDefinition clause, DecisionGenerationOptions options)
    {
        if (clause is null)
            return;
