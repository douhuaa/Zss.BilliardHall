...
public sealed class ADR_902_Architecture_Tests
{
    ...
    [Fact(DisplayName = "ADR-902_1_1: ADR-902 标准模板与结构契约文档存在")]
    ...
    [Fact(DisplayName = "ADR-902_1_2:L1 对应的 Copilot Prompts 文件存在")]
    ...
    [Fact(DisplayName = "ADR-902_1_3:L1 核心治理原则已定义")]
    ...
    [Fact(DisplayName = "ADR-902_1_4:L1 ADR 文档必须包含标准 Front Matter（执法级）")]
    ...
    [Fact(DisplayName = "ADR-902_1_5:L1 ADR 文档必须包含完整章节集合（执法级）")]
    ...
    [Fact(DisplayName = "ADR-902_1_6:L2 Decision 章节必须严格隔离约束性规则（指导级）")]
    ...
    [Fact(DisplayName = "ADR-902_1_7:L1 规则条目必须独立编号（执法级）")]
