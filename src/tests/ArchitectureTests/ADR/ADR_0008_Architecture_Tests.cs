...
/// 
/// ⚠️ **重要变更通知**：ADR-0008 测试已重构为三层架构
/// 
/// 根据问题陈述和 ADR 治理原则，ADR-0008 的测试已从单一文件拆分为三层：
/// 
/// 1. **Governance 层**（宪法级原则验证）
///    位置: ArchitectureTests/Governance/ADR_0008_Governance_Tests.cs
...
/// 【迁移指南】
/// 
/// 如果你正在查找原 ADR_0008_Architecture_Tests 中的测试：
/// 
/// - `ADR_0008_Document_Governance_Constitution_Exists` 
...
/// - ADR-0008: docs/adr/constitutional/ADR-0008-documentation-governance-constitution.md
/// </summary>
