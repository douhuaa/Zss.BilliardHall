...
{
    [Theory(DisplayName = "ADR-0122_1_1: 测试类必须以 Tests 结尾")]
    ...
    [Fact(DisplayName = "ADR-0122_1_2: 架构测试必须在专用项目中")]
    ...
    [Theory(DisplayName = "ADR-0122_1_3: 测试项目必须遵循命名约定")]
    [ClassData(typeof(TestAssemblyData))]
    public void Test_Projects_Must_Follow_Naming_Convention(Assembly testAssembly)
    {
        ...
        isValid.Should().BeTrue($"❌ ADR-0122_1_3 违规: 测试项目命名不符合规范\n\n" +
            $"违规项目: {assemblyName}\n\n" +
            $"修复建议:\n" +
