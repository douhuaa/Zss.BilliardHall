...
/// </summary>
public sealed class ADR_947_5_Architecture_Tests
{
    /// <summary>
    /// ADR-947_5_1: 循环检测
    /// 验证关系声明区不能同时声明 A→B 和 B→A，应使用单向声明+相关关系（§ADR-947_5_1）
    /// </summary>
    [Fact(DisplayName = "ADR-947_5_1: 禁止显式循环依赖声明")]
    public void ADR_947_5_1_Relationships_Must_Not_Have_Bidirectional_Dependencies()
    {
