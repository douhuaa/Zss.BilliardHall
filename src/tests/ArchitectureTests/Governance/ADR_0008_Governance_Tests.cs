...
/// <summary>
/// ADR-0008: 文档治理宪法 - Governance 层测试
/// 
/// 【定位】：验证治理边界的宪法级原则
/// 【不做】：不检查具体执行细节（如禁用词列表）
/// 
...
/// </summary>
public sealed class ADR_0008_Governance_Tests
{
    ...
    [Fact(DisplayName = "ADR-0008.G4: 冲突裁决优先级已定义")]
    ...
    [Fact(DisplayName = "ADR-0008.G5: 防语义扩权原则已定义")]
    ...
    public void ADR_0008_Prompts_File_Exists_And_Declares_No_Authority()
    {
        var repoRoot = FindRepositoryRoot() ?? throw new InvalidOperationException("未找到仓库根目录");
