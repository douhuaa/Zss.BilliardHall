...
public interface IAdrDecisionGenerator
{
    ...
    DecisionGenerationResult GenerateDecisionSection(IRuleSet ruleSet);
    ...
    DecisionGenerationResult GenerateDecisionSection(IRuleSet ruleSet, DecisionGenerationOptions? options = null);
}
