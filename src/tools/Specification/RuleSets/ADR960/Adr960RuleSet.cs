namespace Zss.BilliardHall.Specification.RuleSets.ADR960;

/// <summary>
/// ADR-960：命名规范与约定
/// 定义治理层相关规则和约束（此为框架性定义，需根据实际测试文件完善）
/// </summary>
public sealed class Adr960RuleSet : IArchitectureRuleSetDefinition
{
    /// <summary>
    /// ADR 编号
    /// </summary>
    public int AdrNumber => 960;
    ...
    {
        var ruleSet = new ArchitectureRuleSet(960);
