namespace Zss.BilliardHall.Specification.RuleSets.ADR920;

/// <summary>
/// ADR-920：测试组织与命名规范
/// 定义治理层相关规则和约束（此为框架性定义，需根据实际测试文件完善）
/// </summary>
public sealed class Adr920RuleSet : IArchitectureRuleSetDefinition
{
    /// <summary>
    /// ADR 编号
    /// </summary>
    public int AdrNumber => 920;
