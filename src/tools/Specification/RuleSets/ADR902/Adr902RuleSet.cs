namespace Zss.BilliardHall.Specification.RuleSets.ADR902;

/// <summary>
/// ADR-902：ADR 模板结构契约
/// 定义治理层相关规则和约束（此为框架性定义，需根据实际测试文件完善）
/// </summary>
public sealed class Adr902RuleSet : IArchitectureRuleSetDefinition
{
    /// <summary>
    /// ADR 编号
    /// </summary>
    public int AdrNumber => 902;
    ...
    {
        var ruleSet = new ArchitectureRuleSet(902);

        // Rule 1: 核心规则（需根据测试文件完善）
        ruleSet.AddRule(
            ruleNumber: 1,
            summary: "ADR 模板结构契约核心规则",
